...
public class UnitOfWork : IUnitOfWork
{
    ...
    public IGenericRepository<Usuario> UsuarioRepositoryAsync => new UsuarioRepositoryAsync(_context);

    public IGenericRepository<Rol> RolAsync => new RolRepositoryAsync(_context);
